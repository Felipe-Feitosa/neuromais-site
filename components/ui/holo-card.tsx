...
const ACCENT_TEXT = "var(--motiq-accent-text, #7f9fff)";
    ...
    >
      ...
      <div
        ...
        className={cn(
          ...
          "border border-[var(--motiq-border-strong,#354863)]",
          "focus-visible:ring-2 focus-visible:ring-[var(--motiq-accent,#4f7cff)] focus-visible:ring-offset-2 focus-visible:ring-offset-transparent",
        )}
        style={{
          aspectRatio: aspect > 0 ? String(aspect) : undefined,
          transformStyle: "preserve-3d",
          background:
            "linear-gradient(145deg, var(--motiq-surface-2, #192337), var(--motiq-surface, #111827) 55%, var(--motiq-surface-2, #192337))",
