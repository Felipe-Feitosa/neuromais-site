  ...
  const items: ElasticItemProps[] = [
    {
      ...
      src: "/clinic/recepcao.png",
      alt: "Recepção ampla e colorida da clínica, com espaço de espera confortável para as famílias",
    },
    {
      id: "02",
      title: "Sala ABA",
      category: "Intervenção",
      src: "/clinic/sala-aba.png",
      alt: "Sala de intervenção ABA com mobiliário lúdico e materiais pedagógicos",
    },
    {
      id: "03",
      title: "Sala AVD",
      category: "Autonomia",
      src: "/clinic/sala-avd.png",
      alt: "Sala de atividades de vida diária para o desenvolvimento da autonomia",
    },
    {
      id: "04",
      title: "Psicomotricidade",
      category: "Movimento",
      src: "/clinic/sala-psicomotricidade.png",
      alt: "Sala de psicomotricidade com trampolim, parede de escalada e piscina de bolinhas",
    },
  ];
